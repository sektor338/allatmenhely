...
<button class="button-57" role="button" id="gomb"><span class="text" id="str1">Button 57</span><span id="str2">Alternate text</span></button>
...
<form id="tab1" method="POST" action="includes/hirfeltolt.inc.php">
    <div class="w-full max-w-[40rem] h-[50rem] bg-[#1e6726] rounded-lg mt-5 m-auto">
        ...
        <div class="m-auto max-w-[36rem] h-[37rem] w-full">
            <textarea type="text" name="hir" class="w-full h-full bg-slate-200 rounded-lg mt-6 text-white placeholder:text-white focus:outline-none focus:ring focus:ring-violet-300 pl-2 pt-1 resize-none" placeholder="Ide írd a hír szövegét" style="background-color: #61a352;"></textarea>
        </div>
    </div>
</form>
