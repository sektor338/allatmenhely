...
<div class="container p-4 w-full h-screen relative flex gap-10 max-md:flex-col">
...
<div class="">
    <stripe-buy-button class="ml-[40px] p-[20px] mt-[50px] mr-[5px] flex h-fit block  pl-[4rem] h-[15rem] min-w-[500px] max-w-[500px] border-double border-[2rem] border-secondary rounded-[5rem] "
...
<div class="ex1 min-h-[20rem] w-[36rem] h-fit opacity-70 bg-primary block rounded-[5rem] border-double border-[2rem] border-background ">
        <p class=" text-text text-center font-bold pl-[1rem] pr-[1rem] text-[2rem] mt-[1rem] rotate-[-4deg]">Adományozó pontok: </p>
        <div class="hoverdiv1"><div class="text-white bg-secondary ggver text-center font-bold text-[27px] mt-[2rem] ml-[1rem] mr-[1rem] rounded-[5rem]"><a target="_blank" href="https://www.google.com/maps/place/Budapest,+Gy%C3%B6mr%C5%91i+%C3%BAt+119,+1108/@47.4798978,19.0970548,12.63z/data=!4m6!3m5!1s0x4741c30168ed3c95:0xd05eb36d18cac756!8m2!3d47.4622691!4d19.167785!16s%2Fg%2F11j8w86j07?hl=hu&entry=ttu">Gyömrői út 119, Budapest, Hungary</a> </div></div>
        <div class="hoverdiv2"><div class="text-white bg-secondary ggver text-center font-bold text-[25px] mt-[1rem] ml-[1rem] mr-[1rem] rounded-[5rem]"><a target="_blank" href="https://www.google.com/maps/place/Budapest,+Nagy+Di%C3%B3fa+u.+19,+1072/@47.4911206,19.0658658,13.75z/data=!4m6!3m5!1s0x4741dc680c560d6f:0xc926cd78fc00290a!8m2!3d47.4979425!4d19.0647922!16s%2Fg%2F11csgq7vv2?hl=hu&entry=ttu">Nagy Diófa utca 19, Budapest, Hungary</a>  </div></div>
        <div class="hoverdiv3"><div class="text-white bg-secondary ggver text-center font-bold text-[27px] mt-[1rem] ml-[1rem] mr-[1rem] rounded-[5rem]"><a target="_blank" href="https://www.google.com/maps/place/Budapest,+P%C3%A1rk%C3%A1ny+u.+8,+1138/@47.4801832,18.9156432,12.33z/data=!4m6!3m5!1s0x4741dbefc5006fa9:0x12172d6bee471570!8m2!3d47.5288967!4d19.0598339!16s%2Fg%2F11h0t8rjlv?hl=hu&entry=ttu">Párkány utca 8/d, Budapest, Hungary</a>  </div></div>
        <div class="hoverdiv4"><div class="text-white bg-secondary ggver text-center font-bold text-[27px] mt-[1rem] ml-[1rem] mr-[1rem] rounded-[5rem]"><a target="_blank" href="https://www.google.com/maps/place/Budapest,+Dob+u.+2,+1072/@47.4911205,19.037573,14.25z/data=!4m6!3m5!1s0x4741dc4240572149:0xdd19b90f2ac5f639!8m2!3d47.4962739!4d19.0589894!16s%2Fg%2F11c266mngg?hl=hu&entry=ttu">Dob utca 2., Budapest, Hungary </a> </div></div>
        <div class=""><div class="text-white bg-secondary ggver text-center font-bold text-[27px] mt-[1rem] ml-[1rem] mr-[1rem] mb-[2rem] rounded-[5rem]"><a target="_blank" href="https://www.google.com/maps/place/T%C3%B6k%C3%B6l,+Hermina+%C3%BAt+1-3,+2316/@47.3177192,18.9665462,12.46z/data=!4m6!3m5!1s0x4741e53feca20c75:0x328c186fc99b8234!8m2!3d47.3370125!4d18.9966247!16s%2Fg%2F11qpmtd966?hl=hu&entry=ttu">Hermina út 1-3, Tököl, Hungary </a> </div></div>
</div>
