...
<form method="POST" action="includes/login.inc.php">
    ...
    <input type="text" name="email" id="input-group-1" class="hover:bg-gray-800 bg-gray-900 border border-gray-500 text-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-50 ps-10 p-2.5  " placeholder="Email" required>
    </div></div>
    <div class="flex items-center justify-center">
    <label for="input-group-1" class="block mb-12 text-sm font-medium text-gray-200 dark:text-white"></label>
    <div class="relative mb-6">
    ...
    <input type="password" name="password" id="input-group-1" class="hover:bg-gray-800 bg-gray-900 border border-gray-500 text-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-50 ps-10 p-2.5  " placeholder="Jelszó" required>
    </div>
    </div>

    <div class="flex items-center justify-center">
    <button type="submit" class="mt-12 border-gray-900 text-white bg-green-600 hover:bg-green-500 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 " >Bejelentkezés</button>
