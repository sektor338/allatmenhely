...
<div class="container m-6 p-4 w-full h-screen relative flex gap-10">
    <div class="relative">
        
    <img class="rounded-[5000rem] w-[600px] h-[600px]" src="images/map.webp" alt="">
...
<div class="h-[32rem] w-[18rem] opacity-70 bg-secondary block rounded-[5rem] border-double border-[2rem] border-background">
